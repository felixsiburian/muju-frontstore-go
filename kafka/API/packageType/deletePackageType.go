...
func PublishDeletePackage(c echo.Context) error {
	godotenv.Load(".env")
	data := new(model.PackageType)
	...
	var newTopic = "deletes-package-topic"
	...
	return c.JSON(http.StatusOK, "Package Succesfully Deleted")
}
