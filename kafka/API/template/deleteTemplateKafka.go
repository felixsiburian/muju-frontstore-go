...
func PublishDeleteTemplate(c echo.Context) error {
	godotenv.Load(".env")
	data := new(model.Template)
	...
	var newTopic = "deletes-template-topic"
	...
	return c.JSON(http.StatusOK, "Template is Succesfully Deleted")
}
